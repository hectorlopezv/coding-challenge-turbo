  ...
  return [
    {
      ...
      snippet:
        "Nov 17, 2022 ... The null value represents the intentional absence of any object value. It is one of JavaScript's primitive values and is treated as falsy ...",
      htmlSnippet:
        "Nov 17, 2022 <b>...</b> The <b>null</b> value represents the intentional absence of any object value. It is one of JavaScript&#39;s primitive values and is treated as falsy&nbsp;...",
    ...
    },
    {
      ...
      snippet:
        "adjective ; 1 · having no legal or binding force : invalid ; 2 · having no value : insignificant ; 3 · having no elements.",
      htmlSnippet:
        "adjective ; 1 &middot; having no legal or binding force : invalid ; 2 &middot; having no value : insignificant ; 3 &middot; having no elements.",
    ...
    },
    {
      ...
      snippet:
        "Null. Your daily motivation source Follow the link. linktr.ee/nullmediagroup. 17 posts. 379K followers. 1,560 following.",
      htmlSnippet:
        "<b>Null</b>. Your daily motivation source Follow the link. linktr.ee/nullmediagroup. 17 posts. 379K followers. 1,560 following.",
      ...
      pagemap: {
        ...
        metatags: [
          {
            "og:image":
              "https://scontent-atl3-1.cdninstagram.com/v/t51.2885-19/316574476_128890579991718_5187523294593050028_n.jpg?stp=dst-jpg_s150x150&_nc_ht=scontent-atl3-1.cdninstagram.com&_nc_cat=1&_nc_ohc=dmNaW2-rpdkAX8OL5X6&edm=ABfd0MgBAAAA&ccb=7-5&oh=00_AfBfSF7fX8LMMi5B_30pntecMdYMK1lAF-cxH-E3cjJZmA&oe=638D8D74&_nc_sid=7bff83",
            "theme-color": "#ffffff",
            "og:type": "profile",
            ...
            "og:description":
              "379k Followers, 1,560 Following, 17 Posts - See Instagram photos and videos from Null 🔞 (@null)",
        ...
        cse_image: [
          {
            src: "https://scontent-atl3-1.cdninstagram.com/v/t51.2885-19/316574476_128890579991718_5187523294593050028_n.jpg?stp=dst-jpg_s150x150&_nc_ht=scontent-atl3-1.cdninstagram.com&_nc_cat=1&_nc_ohc=dmNaW2-rpdkAX8OL5X6&edm=ABfd0MgBAAAA&ccb=7-5&oh=00_AfBfSF7fX8LMMi5B_30pntecMdYMK1lAF-cxH-E3cjJZmA&oe=638D8D74&_nc_sid=7bff83",
          },
        ],
      },
    },
    {
      ...
      snippet:
        "2 days ago ... To allow nulls, you can declare a variable as a nullable string by ... First, you can explicitly check whether b is null , and handle the ...",
      htmlSnippet:
        "2 days ago <b>...</b> To allow <b>nulls</b>, you can declare a variable as a nullable string by ... First, you can explicitly check whether b is <b>null</b> , and handle the&nbsp;...",
        ...
        metatags: [
          {
            ...
            "built-on": "2022-11-30T11:55:42.13172",
            "twitter:image:src":
              "https://kotlinlang.org/assets/images/open-graph/docs.png",
            "twitter:site": "@kotlin",
            "og:locale": "en_US",
    ...
    },
    {
      ...
      pagemap: {
        cse_thumbnail: [
          {
            src: "https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcTkQXk6VdlWPLSuQuBtXBkrkeIlUDxVBDb2XQkbP40wsvdGnnyXSNeQByQW",
            width: "318",
            height: "159",
          },
        ],
        ...
        metatags: [
          {
            ...
            "og:image":
              "https://opengraph.githubassets.com/a1e2072774b6d234a856dc51ead35b7dd05eb1dda21e8dd80ddfe5c7c129d10f/guregu/null",
            "twitter:card": "summary_large_image",
            "og:image:width": "1200",
            "theme-color": "#1e2327",
            "og:site_name": "GitHub",
            ...
            "html-safe-nonce":
              "b132632e1400fe5b4bfb6329db5a814fc8b5c76fff1429dda6209534622eb820",
            ...
            "visitor-payload":
              "eyJyZWZlcnJlciI6IiIsInJlcXVlc3RfaWQiOiJCQTMwOjFEQTI6Mzg2N0JCOjU1MzQ5MDo2MzdERTgxQyIsInZpc2l0b3JfaWQiOiI4MTM0MDEyNDI5MjQwNDk0MTEzIiwicmVnaW9uX2VkZ2UiOiJpYWQiLCJyZWdpb25fcmVuZGVyIjoiaWFkIn0=",
            ...
            "enabled-features":
              "IMAGE_METRIC_TRACKING,GEOJSON_AZURE_MAPS,STRICT_DEFERRED_DIFF_LINES_CHECKS",
            "twitter:title":
            ...
            "og:title":
              "GitHub - guregu/null: reasonable handling of nullable values",
            "visitor-hmac":
              "0b189b0c78646e3c9aee7e1d7489d26427a496715233d29218ef0ec55615edce",
            "og:image:height": "600",
            "turbo-cache-control": "no-preview",
            "request-id": "BA30:1DA2:3867BB:553490:637DE81C",
        ...
        cse_image: [
          {
            src: "https://opengraph.githubassets.com/a1e2072774b6d234a856dc51ead35b7dd05eb1dda21e8dd80ddfe5c7c129d10f/guregu/null",
          },
        ],
      },
    },
...
export default async function SearchResults({
  ...
  return (
    <div className="-mt-4 ml-56 mb-24 max-w-3xl">
      {searchTerm && (
        <div className="ml-4 mr-4 mb-5">
          {searchResulst?.map((item: any) => {
            return (
              <div className="flex flex-col mt-10 mb-10">
                <div className="flex items-center">
                  <a href={item.link} className="mr-[0.6rem]">
